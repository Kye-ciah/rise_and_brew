...
class _GalleryAccessState extends State<GalleryAccess> {
  void _handleAllow() {
    // TODO: Implement actual permission request and navigation
          ...
          Expanded(
            child: Center(
              child: Container(
                ...
                padding: const EdgeInsets.all(32), // spacing-2xl
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 24), // spacing-2xl
                    // Buttons
                    Column(
                      children: [
                        // Allow button
                        ...
                        const SizedBox(height: 8), // spacing-xs
                        // Skip for now button
                        SizedBox(
                          width: double.infinity,
