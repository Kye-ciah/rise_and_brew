...
class WifiAccess extends StatefulWidget {
  ...
  @override
  State<WifiAccess> createState() => _WifiAccessState();
}

class _WifiAccessState extends State<WifiAccess> {
  void _handleAllow() {
    // TODO: Implement WiFi permission request and navigation
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Description
                    const Text(
                      'This allows the app to access your wifi settings, can know networks names but not passwords.',
                      style: TextStyle(
                        fontSize: 14,
                        color: Colors.grey,
                      ),
